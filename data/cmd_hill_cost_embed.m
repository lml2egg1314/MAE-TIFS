function flag = cmd_hill_cost_embed(cover_dir, stego_dir, cost_dir, prob_dir, payload)
...
%         end
        ...
        [stego, prob_map] = embed_cmd_hill(cover, payload);
        [rhoP1, rhoM1] = hill_cost(cover, payload);
